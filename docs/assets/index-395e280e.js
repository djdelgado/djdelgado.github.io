  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "nav",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn(
        ...
        isScrolled && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: "#page-top",
            className: "font-semibold text-xl text-black transition-colors",
            children: "David Delgado"
          }
        ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex space-x-6", children: ["About", "Projects", "Photography"].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
        ...
        isMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-full left-0 right-0 bg-white shadow-md py-4 px-4 md:hidden", children: ["About", "Projects", "Photography"].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: `#${item.toLowerCase()}`,
...
const oneShellImg = "/assets/oneshell-6e0c12e5.jpg";
...
const Hero = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 text-center relative z-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-5xl md:text-7xl font-bold text-white mb-4", children: "DAVID DELGADO" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl md:text-2xl font-light text-white mb-8", children: "Full-Stack Software Developer" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            asChild: true,
            className: "bg-[#64A19D] hover:bg-[#558985] text-white rounded px-8 py-5 font-medium",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#about", children: "ABOUT" })
          }
        )
      ] })
    }
...
const profileImg = "/assets/profilepic2-79963f5f.png";
...
const About = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-20 bg-[#161616] text-white text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Root, { className: "AvatarRoot flex justify-center mb-10 rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Image,
      {
        src: profileImg,
        alt: "DD",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg mb-8", children: "I'm a Full-Stack Software Developer in New Orleans, LA, with 8+ years of experience leading cross-functional teams and delivering enterprise-level applications. My edge is integrating agentic AI workflows — using LLMs, MCPs, and autonomous tooling to accelerate delivery and reduce implementation time without sacrificing quality. Outside of work, I geek out over analog photography and running my homelab." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "bg-[#64A19D] h-0.5 w-16 mx-auto mb-10" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-semibold mb-6", children: "Skills" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-4", children: skills.map((skill, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm md:text-base", children: skill }, index)) })
    ] })
  ] }) });
};
...
const poaImg = "/assets/Excursion-Layout-295ce06a.jpg";
...
const perotImg = "/assets/perot-d3671aa3d15305d7876b9c29209b0bff-62c8a597.jpg";

const brothersImg = "/assets/brothers-e51b70563fe5dac19a5553f58a99aa3f-cf103d7a.jpg";

const Photography = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "photography", className: "py-20 bg-stone-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-bold mb-6 text-center", children: "Photography" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "bg-[#64A19D] h-0.5 w-16 mx-auto mb-10" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "order-2 md:order-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: perotImg,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-center order-1 md:order-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold mb-4", children: "Analog" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "bg-[#64A19D] h-0.5 w-12 mb-4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-700 mb-4", children: "It started when I found an old Yashica Electro 35 in a drawer of my grandparents house. I didn't know much about cameras at all, but I figured this would be a good place to start." })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-center items-end", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold mb-4", children: "Street" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "bg-[#64A19D] h-0.5 w-12 mb-4" })
      ] }),
...
const Footer = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-black text-white py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center space-x-4 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://github.com/djdelgado", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", className: "rounded-full bg-white/10 hover:bg-white/20 text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: "lucide lucide-github", href: "https://github.com/djdelgado", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://www.linkedin.com/in/david-j-delgado/", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", className: "rounded-full bg-white/10 hover:bg-white/20 text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: "lucide lucide-linkedin", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "4", height: "12", x: "2", y: "9" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "4", cy: "4", r: "2" })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:djd9062@gmail.com", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", className: "rounded-full bg-white/10 hover:bg-white/20 text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: "lucide lucide-mail", children: [
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, { isScrolled }),
