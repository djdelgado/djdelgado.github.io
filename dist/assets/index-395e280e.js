    ...
    children: /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
          ...
          children: ['About', 'Projects', 'Photography'].map((item) =>
        ...
        isMenuOpen &&
          /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
            className:
              'absolute top-full left-0 right-0 bg-white shadow-md py-4 px-4 md:hidden',
            children: ['About', 'Projects', 'Photography'].map((item) =>
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                'a',
                {
...
const Hero = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx('section', {
    id: 'page-top',
    className:
      'masthead relative flex items-center justify-center h-screen bg-cover bg-center bg-no-repeat',
    style: {
    ...
    children: /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, {
          asChild: true,
          className:
            'bg-[#64A19D] hover:bg-[#558985] text-white rounded px-8 py-5 font-medium',
...
var Avatar = reactExports.forwardRef((props, forwardedRef) => {
...
var AvatarImage = reactExports.forwardRef((props, forwardedRef) => {
  const {
    __scopeAvatar,
    src,
...
var AvatarFallback = reactExports.forwardRef((props, forwardedRef) => {
...
const About = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx('section', {
    id: 'about',
    className: 'py-20 bg-[#161616] text-white text-center',
    children: /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
      className: 'container mx-auto px-4',
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Root, {
          className:
            'AvatarRoot flex justify-center mb-10 rounded-full overflow-hidden',
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, {
              className: 'bg-[#64A19D] h-0.5 w-16 mx-auto mb-10',
            }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
              ...
              children: skills.map((skill, index) =>
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  'div',
                  { className: 'text-sm md:text-base', children: skill },
                  index
                )
              ),
            }),
...
const Projects = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx('section', {
    id: 'projects',
    className: 'py-20 bg-[#222] text-white text-center',
    children: /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
      className: 'container mx-auto px-4',
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx('h2', {
              ...
              'div',
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx('a', {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, {
                    className:
                      'bg-stone-100 text-black overflow-hidden w-full max-w-md cursor-pointer',
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, {
                            className: 'bg-[#64A19D] h-0.5 w-12 mx-auto my-2',
                          }),
                        ],
                      }),
...
const brothersImg =
  '/assets/brothers-e51b70563fe5dac19a5553f58a99aa3f-cf103d7a.jpg';
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, {
                  className: 'bg-[#64A19D] h-0.5 w-12 mb-4',
                }),
                /* @__PURE__ */ jsxRuntimeExports.jsx('p', {
                  className: 'text-gray-700 mb-4',
                  children:
                    "It started when I found an old Yashica Electro 35 in a drawer of my grandparents house. I didn't know much about cameras at all, but I figured this would be a good place to start.",
                }),
              ],
            }),
          ],
    ...
    children: /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx('a', {
              href: 'https://github.com/djdelgado',
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx('a', {
              href: 'https://www.linkedin.com/in/david-j-delgado/',
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, {
                variant: 'ghost',
                size: 'icon',
                className:
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs('p', {
          ...
          children: ['David Delgado © ', currentYear],
        }),
      ],
    }),
  });
